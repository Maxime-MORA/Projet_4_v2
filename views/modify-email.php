<div class="container" style="padding-top:50px;">
    ...
    <form method="post" action="<?=$_SESSION["link"]?>mon-compte-5"style="padding:50px;">
        <label>Votre nouvelle adresse e-mail</label>
         <input id ="modify-email" type="email" name="modify-email" class="form-control input_user" value="" placeholder="Votre nouveau mot de passe" style="margin-bottom:25px;">
